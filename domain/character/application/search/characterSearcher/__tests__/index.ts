...
test('should return a list of characters sorted by name and ordered ascending', async () => {
  ...
  const expectedFirstName = 'Beru Whitesun lars'
  const expectedLastName = 'R5-D4'
  expect(characters[0]).toHaveProperty('name', expectedFirstName)
  expect(characters[9]).toHaveProperty('name', expectedLastName)
})
...
test('should return a list of characters sorted by name, ordered descending and searched by Dar', async () => {
  ...
  const expectedFirstName = 'Darth Vader'
  const expectedLastName = 'Biggs Darklighter'
  expect(characters[0]).toHaveProperty('name', expectedFirstName)
  expect(characters[1]).toHaveProperty('name', expectedLastName)
})
